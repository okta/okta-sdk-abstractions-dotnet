...
In your browser, navigate to: [https://github.com/okta/okta-sdk-abstractions-dotnet](https://github.com/okta/okta-sdk-abstractions-dotnet)

Fork the repository by clicking on the 'Fork' button on the top right hand side.  The fork will happen and you will be taken to your own fork of the repository.  Copy the Git repository URL by clicking on the clipboard next to the URL on the right hand side of the page under '**HTTPS** clone URL'.  You will paste this URL when doing the following `git clone` command.

On your computer, follow these steps to setup a local repository for working on the Okta Abstractions SDK:

``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-sdk-abstractions-dotnet.git
$ cd okta-sdk-abstractions-dotnet
$ git remote add upstream https://github.com/okta/okta-sdk-abstractions-dotnet.git
$ git checkout master
$ git fetch upstream
...
It is important that you maintain an up-to-date `master` branch in your local repository.  This is done by rebasing in the code changes from `upstream/master` (the official Okta Abstractions project repository) into your local repository.  You will want to do this before you start working on a feature as well as right before you submit your changes as a pull request.  I recommend you do this process periodically while you work to make sure you are working off the most recent project code.
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-sdk-abstractions-dotnet](https://github.com/YOUR_ACCOUNT/okta-sdk-abstractions-dotnet)
...
This project and everyone participating in it is governed by the [Okta Code of Conduct](https://github.com/okta/okta-sdk-abstractions-dotnet/tree/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to developers@okta.com.
